...
pub const NNG_PATCH_VERSION: u32 = 3;
...
pub const NNG_OPT_TLS_PEER_CN: &'static [u8; 12usize] = b"tls-peer-cn\0";
pub const NNG_OPT_TLS_PEER_ALT_NAMES: &'static [u8; 19usize] = b"tls-peer-alt-names\0";
...
pub const NNG_OPT_PEER_UID: &'static [u8; 13usize] = b"ipc:peer-uid\0";
pub const NNG_OPT_IPC_PEER_UID: &'static [u8; 13usize] = b"ipc:peer-uid\0";
pub const NNG_OPT_PEER_GID: &'static [u8; 13usize] = b"ipc:peer-gid\0";
pub const NNG_OPT_IPC_PEER_GID: &'static [u8; 13usize] = b"ipc:peer-gid\0";
pub const NNG_OPT_PEER_PID: &'static [u8; 13usize] = b"ipc:peer-pid\0";
pub const NNG_OPT_IPC_PEER_PID: &'static [u8; 13usize] = b"ipc:peer-pid\0";
pub const NNG_OPT_PEER_ZONEID: &'static [u8; 16usize] = b"ipc:peer-zoneid\0";
...
pub const NNG_OPT_SOCKET_FD: &'static [u8; 10usize] = b"socket:fd\0";
pub const NNG_BUS0_SELF: u32 = 112;
pub const NNG_BUS0_PEER: u32 = 112;
pub const NNG_BUS0_SELF_NAME: &'static [u8; 4usize] = b"bus\0";
pub const NNG_BUS0_PEER_NAME: &'static [u8; 4usize] = b"bus\0";
...
pub const NNG_OPT_REQ_RESENDTICK: &'static [u8; 16usize] = b"req:resend-tick\0";
...
fn bindgen_test_layout_nng_sockaddr_in6() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nng_sockaddr_in6>())).sa_scope as *const _ as usize },
        20usize,
        concat!(
            "Offset of field: ",
            stringify!(nng_sockaddr_in6),
...
fn bindgen_test_layout_nng_sockaddr_abstract() {
    ...
    assert_eq!(
        unsafe {
            &(*(::core::ptr::null::<nng_sockaddr_abstract>())).sa_family as *const _ as usize
        },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nng_sockaddr_abstract>())).sa_len as *const _ as usize },
        2usize,
        concat!(
            "Offset of field: ",
            stringify!(nng_sockaddr_abstract),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nng_sockaddr_abstract>())).sa_name as *const _ as usize },
        4usize,
        concat!(
            "Offset of field: ",
            stringify!(nng_sockaddr_abstract),
...
fn bindgen_test_layout_nng_sockaddr_storage() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nng_sockaddr_storage>())).sa_family as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nng_sockaddr_storage>())).sa_pad as *const _ as usize },
        8usize,
        concat!(
            "Offset of field: ",
            stringify!(nng_sockaddr_storage),
...
fn bindgen_test_layout_nng_sockaddr() {
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nng_sockaddr>())).s_abstract as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nng_sockaddr),
    ...
    assert_eq!(
        unsafe { &(*(::core::ptr::null::<nng_sockaddr>())).s_storage as *const _ as usize },
        0usize,
        concat!(
            "Offset of field: ",
            stringify!(nng_sockaddr),
...
extern "C" {
    pub fn nng_msg_reserve(arg1: *mut nng_msg, arg2: usize) -> ::std::os::raw::c_int;
}
extern "C" {
...
pub type nng_init_parameter = ::std::os::raw::c_int;
extern "C" {
